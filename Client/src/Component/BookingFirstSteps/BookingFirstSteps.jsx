         ...
         <div className="container  py-10 px-10 ">
             <div className='w-[400px]'>
                <form  className='form flex flex-col gap-y-10' >
                    <div  >
                        <h1 className='text-3xl text-[#32af6f] font-extrabold hover:text-4xl hover:rotate-2'>START BOOKING NOW</h1>
                    </div>
                    <div className='form-group border h-[50px] bg-white flex justify-start items-center pl-5 rounded-[30px] '>
                        <input type="text" placeholder='Full Name'/>
                    </div>
                    <div className='form-group border h-[50px] bg-white flex justify-start items-center pl-5 rounded-[30px] '>
                        <input type="email" placeholder='Email Address'/>
                    </div>
                    <div className="form-group flex justify-center gap-x-5 ">
                        <div className='w-3/6 flex justify-center gap-x-2'>
