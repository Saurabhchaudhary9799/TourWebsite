                ...
                <div className='flex   justify-center gap-x-5'>
                    ...
                    <div className="user-details flex flex-col gap-y-1 justify-center   px-5">
                         ...
                         <div className='flex gap-x-3 '>
                            <div className=' w-[150px] text-center py-2 rounded-3xl bg-[#32af6f] text-white' onClick={() => {setUpdateProfile(true) ; setUpdatePassword(false)}}>Update Profile</div>
                            <div className='border w-[150px] text-center py-2 rounded-3xl border-[#32af6f]' onClick={() => {setUpdateProfile(false) ; setUpdatePassword(true)}}>Update Password</div> 
                         </div>
                         <div >
